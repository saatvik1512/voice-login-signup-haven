...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-secondary">
      <div 
        className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-lg p-8 w-full max-w-md space-y-6 transform transition-all duration-300 hover:scale-105"
        style={{
      ...
      >
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className={`px-6 py-2 rounded-lg text-sm font-medium transition-all transform hover:scale-110 active:scale-95 ${
              mode === "login"
